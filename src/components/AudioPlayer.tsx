...
const AudioPlayer: React.FC = () => {
  ...
  // Returns the appropriate repeat icon based on repeat mode
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-md border-t border-border animate-slide-up z-50 player-container">
